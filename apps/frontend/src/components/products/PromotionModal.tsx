      ...
      >
        ...
        <div className="px-12 py-4 flex items-center justify-center gap-4 border-b border-orange-50/50 bg-orange-50/20">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all ${step === s ? 'bg-orange-500 text-white shadow-lg shadow-orange-200' : step > s ? 'bg-emerald-500 text-white' : 'bg-slate-100 text-slate-400'}`}>
            ...
            {step === 1 && (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Elige la modalidad que mejor se adapte a tu estrategia de ventas</p>
                </div>

                <div className="grid grid-cols-3 gap-4">
                  <button 
                    onClick={() => setFormData({ ...formData, type: 'NX_M' })}
                    className={`group relative p-4 rounded-xl border-2 transition-all text-left flex flex-col gap-3 ${formData.type === 'NX_M' ? 'border-blue-500 bg-blue-50/30' : 'border-slate-100 bg-white hover:border-blue-200'}`}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold text-slate-400 mt-0.5 leading-tight">Lleva N y paga M</p>
                    </div>
                    <div className="bg-slate-50 rounded-lg p-1.5 text-[8px] font-bold text-slate-400">
                      Ej: Lleva 3, paga 2
                    </div>
                  ...
                  <button 
                    ...
                    className={`group relative p-4 rounded-xl border-2 transition-all text-left flex flex-col gap-3 ${formData.type === 'FIXED_COMBO' ? 'border-purple-500 bg-purple-50/30' : 'border-slate-100 bg-white hover:border-purple-200'}`}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold text-slate-400 mt-0.5 leading-tight">Agrupados a precio especial</p>
                    </div>
                    <div className="bg-slate-50 rounded-lg p-1.5 text-[8px] font-bold text-slate-400">
                  ...
                  <button 
                    ...
                    className={`group relative p-4 rounded-xl border-2 transition-all text-left flex flex-col gap-3 ${formData.type === 'DISCOUNT_PERCENT' ? 'border-amber-500 bg-amber-50/30' : 'border-slate-100 bg-white hover:border-amber-200'}`}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold text-slate-400 mt-0.5 leading-tight">Descuento porcentual</p>
                    </div>
                    <div className="bg-slate-50 rounded-lg p-1.5 text-[8px] font-bold text-slate-400">
            ...
            {step === 2 && (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Selecciona los productos y define las condiciones de la oferta</p>
                </div>
                ...
                <div className="space-y-4">
                  {(formData.type === 'FIXED_COMBO' || formData.type === 'DISCOUNT_PERCENT') && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">
                        ...
                        <input 
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none"
                        />
                      </div>
                      <div>
                        <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">
                  ...
                  <div className="relative">
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Buscar productos para agregar</span>
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-3 text-xs font-bold text-slate-800 focus:border-orange-500 transition-all outline-none"
                      />
                    </div>
                    
                    {searchResults.length > 0 && (
                      <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-slate-100 rounded-2xl shadow-xl z-20 overflow-hidden divide-y divide-slate-50">
                        {searchResults.map(p => (
                          <button key={p.id} onClick={() => addProduct(p)} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 transition-all text-left">
                            <div>
                              ...
                              <p className="text-[10px] text-slate-400 mt-0.5">{p.barcode}</p>
                            </div>
                  ...
                  <div className="space-y-2">
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Productos del combo</span>
                    <div className="min-h-[120px] border-2 border-dashed border-slate-100 rounded-2xl p-4 bg-slate-50/30 flex flex-col gap-2">
                      {formData.products.length === 0 ? (
                        ...
                        formData.products.map((p: any) => (
                          <div key={p.productId} className="flex items-center justify-between bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-bold text-slate-800 truncate">{p.name}</p>
                              <p className="text-[10px] text-slate-400 font-medium">${p.salePrice} c/u</p>
                            </div>
                            <div className="flex items-center gap-3">
                              <div className="flex items-center gap-2 bg-slate-50 rounded-lg p-1">
                                <button onClick={() => updateProductQuantity(p.productId, p.quantity - 1)} className="w-6 h-6 flex items-center justify-center bg-white rounded-md text-slate-400 hover:text-slate-800"><Minus className="w-3 h-3" /></button>
                                <span className="text-xs font-bold text-slate-800 w-4 text-center">{p.quantity}</span>
                                <button onClick={() => updateProductQuantity(p.productId, p.quantity + 1)} className="w-6 h-6 flex items-center justify-center bg-white rounded-md text-slate-400 hover:text-slate-800"><Plus className="w-3 h-3" /></button>
                              </div>
                  ...
                  {formData.type === 'NX_M' ? (
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Lleva (N)</span>
                        <input type="number" value={formData.nValue || ''} onChange={e => setFormData({ ...formData, nValue: parseInt(e.target.value) || 0 })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none" />
                      </div>
                      <div>
                        <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Paga (M)</span>
                        <input type="number" value={formData.mValue || ''} onChange={e => setFormData({ ...formData, mValue: parseInt(e.target.value) || 0 })} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none" />
                      </div>
                    </div>
                  ) : formData.type === 'DISCOUNT_PERCENT' ? (
                    <div>
                      <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">Porcentaje de Descuento (%)</span>
                      <div className="relative">
                    ...
                    <div>
                      <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 block ml-1">💰 Precio final del combo</span>
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-4 py-4 text-lg font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none" 
                        />
                      </div>
                      <p className="text-[10px] text-slate-400 font-bold mt-2 ml-1 uppercase tracking-widest">Valor original: ${calculateTotalOriginal().toFixed(2)}</p>
                    </div>
                  )}

                  {/* Condición de Finalización */}
                  <div className="pt-4 border-t border-slate-200/50">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-3 block ml-1">Condición de Finalización</span>
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl border-2 text-left flex flex-col justify-between transition-all cursor-pointer ${formData.limitType === opt.key ? 'border-orange-500 bg-orange-50/20 text-orange-700' : 'border-slate-100 bg-white hover:border-slate-200 text-slate-500'}`}
                        >
                    ...
                    <div className="mt-4">
                      {formData.limitType === 'STOCK' && (
                        <div className="animate-in slide-in-from-top-2 duration-200">
                          <label className="block text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Límite de Stock Promocional (Unidades)</label>
                          <input 
                            type="number" 
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none" 
                          />
                          <p className="text-[9px] text-slate-400 mt-1 ml-1 font-bold">La promoción se desactivará automáticamente después de vender esta cantidad de productos.</p>
                        </div>
                      )}

                      {formData.limitType === 'DATE' && (
                        <div className="animate-in slide-in-from-top-2 duration-200">
                          <label className="block text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Fecha de Finalización</label>
                          <input 
                            type="date" 
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs font-bold text-slate-800 focus:bg-white focus:border-orange-500 transition-all outline-none" 
                          />
                          <p className="text-[9px] text-slate-400 mt-1 ml-1 font-bold">La promoción estará activa hasta las 23:59:59 del día seleccionado.</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              >
                 <div className="flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <div>
                       ...
                       <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Revisa el resumen antes de activar</p>
                    </div>
                 </div>
                 ...
                 <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6 space-y-4">
                    <div className="flex justify-between items-start">
                       <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Tipo de Promoción</p>
                       ...
                       <div className="text-right">
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Beneficio</p>
                    ...
                    <div className="pt-4 border-t border-slate-200/50">
                       <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Condición de Finalización</p>
                    ...
                    {formData.code && (
                      <div className="pt-4 border-t border-slate-200/50">
                         <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Código / Barcode del Combo</p>
                    ...
                    <div className="pt-4 border-t border-slate-200/50">
                       <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3">Productos Incluidos</p>
                       <div className="space-y-2">
                          {formData.products.map((p: any) => (
        ...
        <div className="px-8 py-6 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
          <button 
            ...
            disabled={step === 1}
            className="flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 text-[11px] font-bold uppercase tracking-widest text-slate-500 hover:bg-white disabled:opacity-30 transition-all"
          >
