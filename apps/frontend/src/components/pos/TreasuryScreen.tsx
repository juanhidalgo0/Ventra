    ...
    <div className="h-full flex flex-col gap-6 bg-slate-50/30 p-2 overflow-y-auto custom-scrollbar pb-10">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="h-24 bg-indigo-600 rounded-xl p-6 text-white text-left shadow-xl shadow-indigo-100 flex flex-col justify-between group active:scale-95 transition-all">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-2">
          ...
          <button className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest flex items-center gap-1 hover:gap-2 transition-all">Ver historial <ChevronRight className="w-3 h-3" /></button>
        </div>
        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold">G</div>
              <div>
                <div className="flex items-center gap-2">
                   <h4 className="text-base font-bold text-gray-800">GO! POS</h4>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <button className="flex items-center justify-center gap-2 py-3 rounded-xl border border-indigo-100 bg-indigo-50 text-indigo-600 text-[10px] font-bold uppercase tracking-widest hover:bg-indigo-100 transition-all">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={cfg.label} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm group hover:border-indigo-100 transition-all flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-gray-400 group-hover:text-indigo-500 transition-colors">
              ...
              <button className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest flex items-center gap-1 mt-6 group-hover:gap-2 transition-all">Configurar <ChevronRight className="w-3 h-3" /></button>
            </div>
          ))}
        </div>
      </div>
      
      <div className="px-4 py-3 bg-indigo-50/50 rounded-2xl border border-indigo-100/50 flex items-center gap-3">
