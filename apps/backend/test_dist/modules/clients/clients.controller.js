...
let ClientsController = class ClientsController {
    ...
    create(data) { return this.clientsService.create(data); }
    update(id, data) { return this.clientsService.update(id, data); }
    addMovement(id, data) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], ClientsController.prototype, "addMovement", null);
