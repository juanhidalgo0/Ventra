...
INSERT INTO "new_products" ("allow_custom_price", "barcode", "brand_id", "category_id", "cost_price", "created_at", "description", "id", "image_url", "is_active", "is_favorite", "min_stock", "name", "presentation_type", "sale_price", "sku", "stock", "supplier_id", "tax_rate", "unit", "units_per_pack", "updated_at") SELECT "allow_custom_price", "barcode", "brand_id", "category_id", "cost_price", "created_at", "description", "id", "image_url", "is_active", "is_favorite", "min_stock", "name", "presentation_type", "sale_price", "sku", "stock", "supplier_id", "tax_rate", "unit", "units_per_pack", "updated_at" FROM "products";
DROP TABLE "products";
